...
# Schedule the upload_file() function to run every day at 2:30 PM local time
schedule.every().day.at("14:46").do(upload_file)

# Keep the script running until the scheduled task is complete
while not schedule.next_run:
    time.sleep(1)
