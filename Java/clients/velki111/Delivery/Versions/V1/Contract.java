...
public class Contract {
    ...
    /**
     * Calculate the final charge per month with decreasing discounts and adding tax for international calls
     * @param defaultRate   double represent the standard value for the package (default value)
     * @return  calculated charge with discounts and taxes
     */
    public double getMonthlyCharge(double defaultRate){
        // Calculate the charge after discount is apply
        double charge = defaultRate - defaultRate * discount;

        // set the charge according to the international calls availability of the contract
        charge = isAllowIntCalls ? charge : charge + defaultRate * 0.15;
