...
public class Contract {
    ...
    private int chargePerMonth;          // Monthly Charge (Default value without any discount or vat)
     ...
     *
     */
    public Contract(PACKAGE packageSize, DATA dataBundle, String date, int period, boolean isAllowIntCalls, String refNumber, String clientName , int chargePerMonth, int discount, ContractT type){
     ...
     * @param chargePerMonth Int represents the monthly charge
     */
    ...
    /**
     * This method is will create the str that should be written to the file.
     * @return str with relevant fields separated by tab
     */
    @Override
    public String toString() {
        String str = "";
        str = str + getDate() + "\t" + (getPackageSize().ordinal() + 1) + "\t";
        str = str + (getDataBundle().ordinal() + 1) + "\t";
        str =  str + getPeriod() + "\t";
        str = str + Utilities.booleanToYN(isAllowIntCalls()).charAt(0) + "\t";
        str = str + getRefNumber() + "\t";
        str = str + getChargePerMonth() + "\t";
        str = str + getClientName() + "\n";
        return str;
    }
}
