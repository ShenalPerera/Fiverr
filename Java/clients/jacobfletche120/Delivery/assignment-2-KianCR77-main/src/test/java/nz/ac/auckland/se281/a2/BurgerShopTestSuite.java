...
public class BurgerShopTestSuite {
	...
	public static class YourTest extends TaskTest {
		@Test
		public void T5_1_cannot_remove_from_cart_empty(){
			runCommands(ADD+" 1", CLEAR_CART, REMOVE+" 0");
			assertContains(MessagesCLI.CART_EMPTY.getMessage());
		}

		@Test
		public void T5_2_cannot_clear_empty_cart(){
			runCommands(CLEAR_CART);
			assertContains(MessagesCLI.CART_EMPTY.getMessage());
		}

		@Test
		public void T5_3_combo_false_with_same_size_snack_drinks(){
			runCommands(ADD + " 1", ADD + " 9", "L", ADD + " 13", "L",ORDER);
			assertContains(MessagesCLI.MISSED_COMBO.getMessage());
		}

		@Test
		public void T5_3_cart_is_not_empty(){
			runCommands(ADD + " 1", ADD + " 9", "L", ADD + " 13", "L",ORDER,SHOW_CART);
