...
public class Main {
    ...
    public static void readData() {
        try {
            ...
            Scanner in = new Scanner(new File("C:\\Users\\shena\\Desktop\\Fiverr\\repo\\Fiverr\\Java\\clients\\adam_sa\\Sample Datasets\\SampleDataset -CVE.csv"));
            in.nextLine();
            ...
            in = new Scanner(new File("C:\\Users\\shena\\Desktop\\Fiverr\\repo\\Fiverr\\Java\\clients\\adam_sa\\Sample Datasets\\SampleDataset -Vendors.csv"));
            while (in.hasNextLine()) {
                String line = in.nextLine();
                String[] recs = line.split(",");
                if (recs.length == 2) {
            ...
            in = new Scanner(new File("C:\\Users\\shena\\Desktop\\Fiverr\\repo\\Fiverr\\Java\\clients\\adam_sa\\Sample Datasets\\SampleDataset - Products.csv"));
            while (in.hasNextLine()) {
                String line = in.nextLine();
                String[] recs = line.split(",");
                if (recs.length == 2) {
