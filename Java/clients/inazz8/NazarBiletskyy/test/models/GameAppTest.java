...
public class GameAppTest {
    ...
    void setUp() {
        ...
        edAppBelowBoundary = new GameApp(developerLego, "WeDo", 1, 1.0, 0,);
        edAppOnBoundary = new GameApp(developerLego, "Spike", 1000, 2.0, 1.99,);
        edAppAboveBoundary = new GameApp(developerLego, "EV3", 1001, 3.5, 2.99, );
        edAppInvalidData = new GameApp(developerLego, "", -1, 0, -1.00,);
    }
