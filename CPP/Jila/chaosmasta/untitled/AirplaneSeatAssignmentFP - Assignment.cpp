...
int main()
{
    ...
    Plane JMLAir(NUM_SEAT_ROWS,NUM_SEAT_LETTERS);
    ...
    do {
        ...
        switch (choice) {
            ...
            case MENU_FIND_PASSENGER:
                ...
                //*** YOUR CODE HERE
                //***
                seat = findPassenger(passengerName,JMLAir);
                cout << endl;
            ...
            case MENU_SHOW_OCCUPANT:
                ...
                //*** YOUR CODE HERE
                //***
                passengerName = showOccupant(seat,JMLAir);
                cout << endl;
            ...
            case MENU_MOVE_PASSENGER:
                ...
                //*** YOUR CODE HERE
                //***
                oldSeat = findPassenger(passengerNameToMove,JMLAir);
                cout << endl;
                ...
                if (oldSeat != EMPTY_SEAT) {
                    ...
                    //*** YOUR CODE HERE
                    //***
                    passengerName = showOccupant(newSeat,JMLAir);
                    if (passengerName == EMPTY_SEAT) {
            ...
            case MENU_REQUEST_WINDOW:
                ...
                //*** YOUR CODE HERE
                //***
                seat = requestWindowAisle(MENU_REQUEST_WINDOW,JMLAir);
                if (seat != EMPTY_SEAT) {
            ...
            case MENU_REQUEST_AISLE:
                ...
                //*** YOUR CODE HERE
                //***
                seat = requestWindowAisle(MENU_REQUEST_AISLE,JMLAir);
                if (seat != EMPTY_SEAT) {
...
string findPassenger(string passengerName, Plane plane)
{
    ...
    //***
    row = 0;
    while (!found && row < NUM_SEAT_ROWS){
        letter = 0;
        while (!found && letter < NUM_SEAT_LETTERS){
            if (upperCase(seats[row][letter].getPassengerName()) == passengerName){
                seat = padRowNum(row) + string(SEAT_STR_LETTER_NUM_CHARS, SEAT_TYPE_INDEX[letter]);
                found = true;
            }
            letter ++;
...
string showOccupant(string seat, Plane plane)
{
    ...
    //*** YOUR CODE HERE
    //***
    passengerName = seats[rowNum][letterIndex].getPassengerName();
...
bool assignSeat(string seat, string passengerName, Plane plane)
{
    ...
    //*** Place your if-condition in this if-statement.
    //***
    if (seats[rowNum][letterIndex].getPassengerName() == EMPTY_SEAT) {
        //***
        //*** Place your code in this if-statement-block.
        //***
        seats[rowNum][letterIndex].setPassengerName(passengerName);
        assignSeatOK = true;
    }
...
bool releaseSeat(string seat, Plane plane)
{
    ...
    //*** YOUR CODE HERE
    //***
    seats[rowNum][letterIndex].setPassengerName(EMPTY_SEAT);
...
string requestWindowAisle(int seatType, Plane plane)
{
    ...
    case MENU_REQUEST_WINDOW:
        ...
        //***
        letter = 0;
        while(!requestOK && letter < NUM_SEAT_LETTERS){
            row =0;
            while (!requestOK && row < NUM_SEAT_ROWS){
                if (upperCase(seats[row][WINDOW_SEAT_INDEX[letter]].getPassengerName()) == EMPTY_SEAT){
                    seat = padRowNum(row) + string(SEAT_STR_LETTER_NUM_CHARS, SEAT_TYPE_INDEX[WINDOW_SEAT_INDEX[letter]]);
                    requestOK = true;
                }
                row++;
            }
    ...
    //***
        ...
        while(!requestOK && letter < NUM_AISLE_SEAT_LETTERS){
            row = 0;
            while (!requestOK && row < NUM_SEAT_ROWS){
                if (upperCase(seats[row][AISLE_SEAT_INDEX[letter]].getPassengerName())== EMPTY_SEAT){
                    seat = padRowNum(row) + string(SEAT_STR_LETTER_NUM_CHARS, SEAT_TYPE_INDEX[AISLE_SEAT_INDEX[letter]]);
                    requestOK = true;
                }
                row++;
            }
