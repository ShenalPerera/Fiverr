...
Transaction::Transaction(const std::string fromAccountNumberIn, const std::string toAccountNumberIn,const std::string amountIn):
        fromAccountNumber(fromAccountNumberIn),toAccountNumber(toAccountNumberIn),amount(amountIn){}
...
// Setters
void Transaction::setFromAccountNumber(const std::string fromAccountNumberIn) {
    fromAccountNumber = fromAccountNumberIn;
}

void Transaction::setToAccountNumber(const std::string toAccountNumberIn) {
    toAccountNumber = toAccountNumberIn;
}

void Transaction::setAmount(const std::string amountIn) {
    amount = amountIn;
}
