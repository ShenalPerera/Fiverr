...
public:
    ...
    **/
    ...
    /*
        @param   index : the index of item to find in the list
        @pre      : takes index of item object and checks if exist in list and return
        @return   : returns the position (index) of object
...
*/
    ...
    void reverseCopy(const LinkedList<ItemType> &);
