...
//***
Plane::Plane(int numOfRows, int numOfLetters) {
    setNumberOfRows(numOfRows);
    setNumberOfLetters(numOfLetters);
    setSeats(numOfRows,numOfLetters);
    loadPlane();
}
...
//***
int Plane::getNumberOfRows() const {
    return numberOfRows;
}
...
//***       the method header just like you did in the prototype.
//***
int Plane::getNumberOfLetters() const {
...
//***
void Plane::setNumberOfRows(int numOfRows) {
...
//*** REMEMBER: setters do not return anything.
//***
void Plane::setNumberOfLetters(int numOfLetters) {
...
//*** REMEMBER: setters do not return anything.
//***
void Plane::setSeats(int numOfRows, int numOfLetters) {
    seats = new Seat*[numOfRows];

    for(int i = 0; i<= numOfRows -1; i++){
        seats[i] = new Seat[numOfLetters];
        cout << numOfLetters;
    }
}
...
//***       operator. See Chapter 9.6.
//***
bool Plane::assignSeat(Plane plane, string seat, string passengerName) {
